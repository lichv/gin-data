<template>
	<el-card class="temp-flag-distribution-card" >
		<template #header>
			<div class="card-header">
				<span>临时表 Flag状态</span>
			</div>
		</template>
...
<script>
	...
	export default {
		...
		methods:{
			...
			getData:function(){
				let _this = this;
				api.getTempFlagDistribution.send(this.form)
				.then(result => {
